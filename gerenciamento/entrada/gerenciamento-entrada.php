...
<body>
    <nav class="navbar bg-primary fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="../home.php" style="color: white">Sistema de Gerenciamento | Registro de entrada</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                <div class="offcanvas-header" style="background-color: blue;">
                    <h5 class="offcanvas-title" id="offcanvasNavbarLabel" style="color:aliceblue">Gerenciamento de entrada</h5>
        ...
        <div class="row">
            <div class="col mt-5">
                ...
                switch (@$_REQUEST["page"]) {
                    case "novo":
                        include("nova-entrada.php");
                        break;
                    case "salvar":
                        include("salvar-entrada.php");
                        break;
                    case "editar":
                        include("editar-entrada.php");
                        break;
                    default:
                        include("listar-entrada.php");
                        break;
                }
                ?>
            </div>
